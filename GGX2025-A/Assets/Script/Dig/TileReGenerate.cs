...
public class TileReGenerate : MonoBehaviour
{
    ...
    private const int maxSimultaneousSounds = 7;  // 同時に鳴っていい最大数
    private const float soundTimeWindow = 0.1f;   // 何秒以内の再生を「同時」とみなすか
